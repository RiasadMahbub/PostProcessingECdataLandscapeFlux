...
filtered_data = Way3_filtered[(Way3_filtered[11] > 0) & (Way3_filtered[11] < 2000)]
...
plt.title("Way 3 H2o molar density histogram of 20 hz data 2021")
# Disable exponential notation on the x-axis
plt.ticklabel_format(style='plain', axis='x', useOffset=False)
plt.ticklabel_format(style='plain', axis='y', useOffset=False)
# Save the figure
plt.savefig(export_dir + '/H2Omolardensity2Way3.jpeg', dpi=500)
...
plt.ylim(-5, 2500)
plt.title("Way 3 H2o molar density time series of 20 hz data 2021")
plt.savefig(export_dir + '/H2OmolardensityscatterplotWay3.jpeg', dpi=500)
...
daily_counts.to_csv(export_dir + '/daily_countsWay3.csv', header=True)
...
daily_average.to_csv(export_dir + '/daily_averageWay3.csv', header=True)
...
plt.title("Time series plot Daily Average of H20 Molar density (mmol/m$^3$)  of Way 3  in 2021")
#plt.show()
...
plt.xlabel("Date")
plt.ylabel("H20 Molar density (mmol/m$^3$)")
plt.title(" Time series plot Daily 8 day moving Average of H20 Molar density (mmol/m$^3$)  of way 3  in 2021")
plt.savefig(export_dir + '/8dayDailyaverageWay3.jpeg', dpi=200) # Save the figure in the specified directory
...
daily_average = filtered_data.groupby('Date')[11].mean()
# Print the daily average values
moving_average.to_csv(export_dir + '/8daily_averageWay3.csv', header=True)
...
plt.xlabel("Date")
plt.ylabel("Daily 5th Percentile of H20 Molar density Way 3(mmol/m$^3$)")
plt.title("Daily 5th Percentile of H20 Molar density Way 3(mmol/m$^3$) over Time")
# Save the figure as a JPEG file
plt.savefig(export_dir + '/Daily_5th_percentileWay3.jpeg', dpi=100)
daily_5th_percentile.to_csv(export_dir + '/daily_5th_percentileWay3.csv', header=True)
...
plt.xlabel("Date")
plt.ylabel("Daily 25th Percentile of H20 Molar density Way 3 (mmol/m$^3$)")
plt.title("Daily 25th Percentile of H20 Molar density Way 3 (mmol/m$^3$) over Time")
# Save the figure as a JPEG file
plt.savefig(export_dir + '/Daily_25th_PercentileWay3.jpeg', dpi=100)
daily_25th_percentile.to_csv(export_dir + '/daily_25th_percentileWay3.csv', header=True)
...
plt.xlabel("Date")
plt.ylabel("Daily 75th Percentile of H20 Molar density Way 3(mmol/m$^3$)")
plt.title("Daily 75th Percentile of H20 Molar density Way 3(mmol/m$^3$) over Time")
# Save the figure as a JPEG file
plt.savefig(export_dir + '/Daily_75th_PercentileWay3.jpeg', dpi=100)
daily_75th_percentile.to_csv(export_dir + '/daily_75th_percentileWay3.csv', header=True)
...
plt.xlabel("Date")
plt.ylabel("Daily 95th Percentile of H20 Molar density Way 3(mmol/m$^3$)")
plt.title("Daily 95th Percentile of H20 Molar density Way 3(mmol/m$^3$) over Time")
# Add a legend
plt.legend(['Moving Average'], loc='upper right')
# Save the figure as a JPEG file
plt.savefig(export_dir + '/Daily_95th_PercentileWay3.jpeg', dpi=100)
daily_95th_percentile.to_csv(export_dir + '/daily_95th_percentileWay3.csv', header=True)
...
plt.xlabel("Date")
plt.ylabel("Daily Median of H20 Molar density Way 3 (mmol/m$^3$)")
plt.title("Daily Median of H20 Molar density Way 3(mmol/m$^3$) over Time")
# Add a legend
plt.legend(['Moving Average'], loc='upper right')
# Save the figure as a JPEG file
plt.savefig(export_dir + '/daily_median.jpeg', dpi=100)
daily_median.to_csv(export_dir + '/daily_medianWay3.csv', header=True)
